...
// const textOut = `ini tuh penjelasan ttg alpukat di bahasa inggris : ${textIn}`;
...
// fs.readFile('./txt/startafjoafhuawfuaufhawuf.txt', 'utf-8', (err, data) => {    
//     if (err) return console.log('ini ada error di read file 1');
